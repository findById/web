...
public class CaptchaUtils {
    ...
    public CaptchaUtils(int width, int height, int codeCount) {
        this.width = width;
        this.height = height;
...
//		// 自定义参数
//		CaptchaUtils code = new CaptchaUtils(width, height, codeCount, lineCount);
//		String sessionId = session.getId();
//		RedisUtils.set("captcha_" + sessionId, code.getCode(), 60 * 30);
