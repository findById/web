...
//                return String.format("%.2fGB", size / 1024F / 1024 / 1024);
            }
            if (size >> 50 < 1) {
                return String.format("%sTB", df.format(size / 1024. / 1024 / 1024 / 1024));
//                return String.format("%.2fTB", size / 1024F / 1024 / 1024 / 1024);
            }
            if (size >> 60 < 1) {
                return String.format("%sPB", df.format(size / 1024. / 1024 / 1024 / 1024 / 1024));
//                return String.format("%.2fPB", size / 1024F / 1024 / 1024 / 1024 / 1024);
            }
            return String.format("%sEB", df.format(size / 1024. / 1024 / 1024 / 1024 / 1024 / 1024));
//            return String.format("%.2fEB", size / 1024F / 1024 / 1024 / 1024 / 1024 / 1024);
        } catch (Exception e) {
            return "";
        } finally {
        }
